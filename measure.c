...
struct MerakiRange meraki_byte_to_screen_idx(meraki_measure_func m, size_t idx, size_t len,
                                 char *str) {
  // TODO: refactor
...
struct MerakiRange meraki_screen_to_byte_idx(meraki_measure_func m, size_t idx, size_t len,
                                 char *str);
